 ...
 */
$databases['default']['default'] = array(
  'database' => '{{ drupal_mysql_db }}',
  'username' => '{{ drupal_mysql_user }}',
  'password' => '{{ drupal_mysql_passwd }}',
  'host' => '{{ drupal_mysql_host }}',
  'port' => '',
  'driver' => 'mysql',
  'prefix' => '',
);
 ...
 * for you.
 */
$base_url = 'http://{{ drupal_domain }}';  // NO trailing slash!
 ...
 */
$conf['environment_settings'] = array(
	'data_portal_base_url' => '{{ data_portal_base_url }}',
	'gbif_api_base_url' => '{{ gbif_api_base_url }}', 
	'gbif_api_version' => '{{ gbif_api_version }}',
);

/**
 * GBIF IMS credentials
 */
$conf['ims_connection'] = array(
	'database' => '{{ gbif_ims_db }}',
	'hostname' => '{{ gbif_ims_host }}',
	'username' => '{{ gbif_ims_user }}',
	'password' => '{{ gbif_ims_passwd }}',
);