...
$_xhprof['dbuser'] = '{{ mysql_admin_user }}';
$_xhprof['dbpass'] = '{{ mysql_admin_passwd }}';
$_xhprof['dbname'] = 'xhprof';
$_xhprof['dbadapter'] = 'Pdo';
$_xhprof['servername'] = '{{ php_xhprof_ServerName }}';
$_xhprof['namespace'] = '{{ project_machine_name }}';
$_xhprof['url'] = 'http://{{ php_xhprof_ServerName }}';
/*
